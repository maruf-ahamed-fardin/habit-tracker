  ...
  const tab = ({ href, label, icon: Icon }: (typeof NAV_ITEMS)[number]) => {
    ...
    return (
      <Link
        ...
        className={cn(
          'relative flex h-full flex-col items-center justify-center gap-1 rounded-2xl text-[11px] font-medium outline-none transition-colors focus-visible:ring-3 focus-visible:ring-ring/50',
